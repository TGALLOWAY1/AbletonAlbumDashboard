 ...
 * and studio (owned directly, migration 0028). On a database without 0028 the
 ...
 * by dropping the studio half in that branch: without 0028 there are no
...
async function fetchTaskCompletions(
  ...
  console.warn(
    "[analytics] actions.owner_id is missing — counting track tasks only. " +
      "Apply supabase/migrations/0028_general_tasks.sql to include studio tasks.",
  );
